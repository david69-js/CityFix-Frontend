...
const getStyles = (colors: any) => StyleSheet.create({
  ...
  errorContainer: { flexDirection: 'row', backgroundColor: colors.danger + '20', padding: 12, borderRadius: 8, alignItems: 'center', marginBottom: 20, borderWidth: 1, borderColor: colors.danger },
  errorText: { color: colors.error, marginLeft: 8, fontSize: 13, fontWeight: '500', flex: 1 },
  codeContainer: { backgroundColor: colors.surface, padding: 16, borderRadius: 16, borderWidth: 1, borderColor: colors.border, marginBottom: 24 },
  codeVerifiedContainer: { backgroundColor: colors.iconGreenBg, borderColor: colors.workerGreen },
  ...
  verifyBtn: { backgroundColor: colors.primary, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 8 },
  ...
  primaryButtonDisabled: { backgroundColor: colors.primary + '60', shadowOpacity: 0 },
